          ...
          <div className="row">
            <div className="col-md-12 text-center" style={{borderStyle: 'solid', borderColor: 'rgb(84,29,5)', textAlign: 'center', height: 300}}>
              <form style={{textAlign: 'left'}}>
                <h1 style={{color: 'rgb(84,29,5)', fontFamily: 'Adamina, serif', fontSize: 28, marginTop: 10, width: 'auto', textAlign: 'left'}}><i className="la la-book" style={{borderRightStyle: 'solid', marginRight: 5}} />Add Book<input type="text" className="form-control" placeholder="Enter Title" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20}} /><input type="text" placeholder="Enter Isbn" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /><input type="text" placeholder="Enter Publication Year" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /><input type="text" placeholder="Enter Author" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /><input type="text" placeholder="Enter Publisher" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /><input type="text" placeholder="Image_url_s:" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /><input type="text" placeholder="Image_url_m:" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /><input type="text" placeholder="Image_url_l:" className="form-control" style={{boxShadow: '0px 0px', borderColor: 'rgb(10,10,10)', width: 250, textAlign: 'center', marginLeft: 35, height: 20, marginTop: 5}} /></h1>
